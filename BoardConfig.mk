...
# Kernel
BOARD_KERNEL_CMDLINE := console=tty0 androidboot.console=ttyHSL0 androidboot.hardware=qcom msm_rtb.filter=0x237 ehci-hcd.park=3 androidboot.bootdevice=7824900.sdhci lpm_levels.sleep_disabled=1 earlyprintk ramoops_memreserve=4M androidboot.selinux=permissive
...
TARGET_KERNEL_CONFIG := halium_rimo02a_defconfig 
...
WIFI_DRIVER_OPERSTATE_PATH := "/sys/class/net/rndis0/operstate"
